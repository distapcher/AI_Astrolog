...
async def cmd_start(message: Message) -> None:
    await message.answer(
        ...
        "Построю подробную натальную карту по дате, времени и месту рождения:\n"
        "• планеты, астероиды, узлы, Vertex, Парс Фортуны\n"
        "• мажорные и минорные аспекты, паттерны (йод, стеллиум)\n"
        "• фаза Луны, транзиты, стихии и кресты\n\n"
...
async def cmd_help(message: Message) -> None:
    await message.answer(
        ...
        "Отчёт как в полной натальной карте: позиции, аспекты, паттерны, фаза Луны.\n\n"
